...
export default class TrainPost extends Component {
    ...
    { 
        ...
        let URL = 'http://192.168.137.91/LastTrain/getPostComments/'.concat(this.state.postID);
        fetch(URL)
    ...
    submitComment = () => 
    {
        ...
        // alert(CFU);
        let URL = 'http://192.168.137.91/LastTrain/api/CommentsOnTrains';
        fetch(URL, 
            {
                method: 'POST',
                body: CFU,  
    ...
    getUsers = () =>
    {
        var url = 'http://192.168.137.91/LastTrain/api/Login';
        fetch(url)
            .then(response => response.json())
            .then(users => {
                this.setState({ users });
                            ...
                            return (
                                ...
                                >
                                    {/* <View style={{ 
                                            ...
                                            borderBottomColor: Colors.headerColor.color, 
                                            borderBottomWidth: 0.5,
                                            marginBottom:15,
